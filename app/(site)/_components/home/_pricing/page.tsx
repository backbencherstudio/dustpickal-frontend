"use client";
import { subscriptionPlans } from "@/app/(user)/subscription/subscriptionData";
            ...
            <div className="col-span-10 flex flex-col gap-7">
              <div className="flex justify-center -ml-20 w-full p-[2px] my-10 rounded">
                <div className="border rounded-md bg-[#e9e9ea]">
                  ...
                  <button
                    className={`px-2 py-1 rounded-r cursor-pointer text-base font-medium ${
                      selected === "annual"
                        ? "bg-white text-[#4A4C56] rounded"
                        : "text-[#777980]"
                    }`}
                ...
                {subscriptionPlans.map((plan) => (
                  <div key={plan.id} className={getCardStyles(plan)}>
                    ...
                    <div className="flex flex-col gap-3">
                      <p className="text-base font-medium text-[#1D1F2C]">
                        {plan.name}
                      </p>
                      <div className="flex flex-col gap-1">
                        <p className="text-base font-medium text-[#777980]">
                          ...
                          <span className="text-xl font-medium text-[#777980]">
                            {" "}
                            /{" "}
                          </span>
                    ...
                    <div className="flex flex-col gap-3">
                      {plan.annualDiscount && (
                        <p className="text-xs font-medium text-[#777980]">
                          Purchase annually and save{" "}
                          <span className="text-[#22CAAD]">
                            {plan.annualDiscount.percentage}% - $
