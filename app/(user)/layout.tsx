  ...
  return (
    <RouteProtection allowedUserType="user">
      <div className="flex h-screen overflow-hidden">
        {/* Left sidebar */}
        <div
          className={`${isLeftExpanded ? "w-[280px]" : "w-[80px]"
        ...
        {/* Right sidebar */}
        <div
          className={`${isRightExpanded ? "w-[250px]" : "w-[80px]"
            } transition-all duration-300 ease-in-out hidden lg:block`}
        >
          <RightSideBar
        ...
        <div className="lg:hidden w-full h-full relative">
          {/* Mobile left sidebar */}
          <div
            className={`fixed inset-y-0 left-0 z-40 transform transition-transform duration-300 ease-in-out ${isLeftExpanded ? "translate-x-0" : "-translate-x-full"
              }`}
          >
          ...
          <div
            className={`fixed inset-y-0 right-0 z-40 transform transition-transform duration-300 ease-in-out ${isRightExpanded ? "translate-x-0" : "translate-x-full"
              }`}
          >
            <div className="w-64 h-full bg-white shadow-lg">
              <RightSideBar
