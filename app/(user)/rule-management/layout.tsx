        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-2 xl:gap-0">
            ...
            <div className="xl:col-span-10">
                <div className="flex flex-col gap-1 pb-2 border-b border-[#E9E9EA]">
                    <h3 className="text-xl text-[#1D1F2C] font-medium">Rule Management</h3>
                    <p className="text-sm font-medium text-[#777980]">Manage your custom rules. Edit, delete, & create new rules.</p>
                </div>
                {children}
            </div>
